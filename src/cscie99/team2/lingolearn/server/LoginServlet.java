...
public class LoginServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		session.setAttribute(UserServiceImpl.GMAIL_SESSION_KEY, null);
		session.setAttribute(UserServiceImpl.GID_SESSION_KEY, null);
	...
	/**
	 * the HTTP POST method is used for login. No content is served, rather this
	 * is an endpoint for a REST ajax call. The request parameters expect the
	 * following "gmail" : the gmail address of a user signed into gmail
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			String gmail = req.getParameter("gmail") != null ? req
					.getParameter("gmail") : "";

			String gplusId = req.getParameter("gplusid") != null ? req
					.getParameter("gplusid") : "";
			...
			if (gplusId.equals("") || gmail.equals("")) {
				...
				HttpSession session = req.getSession();
				session.setAttribute(UserServiceImpl.GMAIL_SESSION_KEY, gmail);
				session.setAttribute(UserServiceImpl.GID_SESSION_KEY, gplusId);
				json = "true";
			}
